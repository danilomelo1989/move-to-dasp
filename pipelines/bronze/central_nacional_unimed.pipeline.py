...
from modules.customers.central_nacional_unimed.pipeline import execute_pipeline
from modules.customers.central_nacional_unimed.pipeline import execute_pipeline_managerial
