...
table.upload_table_to_snowflake('CADASTRO_AMIL', schema='DATABRICKS_SILVER', mode='Overwrite')

# COMMAND ----------

carrier = 'AMIL'
table_name = 'AMIL_PARTICIPACAO_1'
...
table.column_cast(config)
table.upload_table_to_snowflake('PARTICIPACAO_1_AMIL', schema='DATABRICKS_SILVER', mode='Overwrite')

# COMMAND ----------

carrier = 'AMIL'
table_name = 'AMIL_PARTICIPACAO_2'
file_type = 'PARTICIPACAO'
...
table.column_cast(config)
table.upload_table_to_snowflake('PARTICIPACAO_2_AMIL', schema='DATABRICKS_SILVER', mode='Overwrite')

# COMMAND ----------

carrier = 'AMIL'
table_name = 'AMIL_PARTICIPACAO_3'
file_type = 'PARTICIPACAO'
...
table.column_cast(config)
table.upload_table_to_snowflake('PARTICIPACAO_3_AMIL', schema='DATABRICKS_SILVER', mode='Overwrite')

# COMMAND ----------

carrier = 'AMIL'
table_name = 'AMIL_PREMIO'
file_type = 'PREMIO'
...
table.column_cast(config)
table.upload_table_to_snowflake('PREMIO_AMIL', schema='DATABRICKS_SILVER', mode='Overwrite')

# COMMAND ----------

carrier = 'AMIL'
table_name = 'AMIL_SINISTRO'
file_type = 'SINISTRO'
...
config = {
    ...
    'CODIGO_PRESTADOR' : {'type':'string'},
    'DESCRICAO_PRESTADOR' : {'type':'string'},
    'QUANTIDADE_SINISTRO_CONTA' :  {'type':'regex' , "pattern":"nan", "replace":"0"},
    ...
    'QUANTIDADE_PROCEDIMENTO' : {'type':'regex' , "pattern":"nan", "replace":"0"},
    'INDICA_RESTITUICAO_GLOSA' : {'type':'string'},
    'NUMERO_PROTOCOLO_ANS' : {'type':'string'},
    'NUMERO_REEMBOLSO_ANS' : {'type':'string'},
...
table.column_cast(config)
table.upload_table_to_snowflake('SINISTRO_AMIL', schema='DATABRICKS_SILVER', mode='Overwrite')
